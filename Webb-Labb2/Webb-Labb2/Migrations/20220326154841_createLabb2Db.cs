...
{
    public partial class createLabb2Db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCourses", x => new { x.UserId, x.CourseNumber });
                    table.ForeignKey(
                        name: "FK_UserCourses_Courses_CourseNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCourses_CourseNumber",
                table: "UserCourses",
                column: "CourseNumber");
        }
